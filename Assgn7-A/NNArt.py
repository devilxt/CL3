...
def denormalize(tensor):
    """Reverts the normalization so we can view/save the image."""
...
class VGG(nn.Module):
    def __init__(self):
        ...
        # Load the pre-trained VGG19 features
...
def run_style_transfer():
    ...
    print("Style transfer complete! Image saved as 'final_artistic_image.png'.")
